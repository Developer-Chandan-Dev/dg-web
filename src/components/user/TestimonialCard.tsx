    ...
    return (
        <div className="p-4 md:w-1/2 w-full">
            <div className="h-full feature-card ">
                ...
                <p className="leading-relaxed text-[15px] mb-6">{content}</p>
                <a className="inline-flex items-center">
                    <Image src={image} alt="testimonial" width="48" height="48"
                           className="rounded-full flex-shrink-0 object-cover object-center"/>
                    <span className="flex-grow flex flex-col pl-4">
                        <span className="title-font font-medium text-gray-900 dark:text-gray-100">{name}</span>
