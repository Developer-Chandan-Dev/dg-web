        ...
        <section className="py-20 w-full h-auto">
            <div className="flex items-center lg:w-[1200px] justify-center flex-col w-full text-center mx-auto">
                <div className="w-full lg:w-[50%]">
                    <h2 className="py-3">
                        Featured Digital <span className="gradient-text">Marketing<br /> Courses</span>
                    </h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab accusamus adipisci alias aliquam
                        animi consectetur dignissimos...</p>
                </div>
                    ...
                    {featuredCourses?.map((course: any) => (
                        <Link key={course.id} href={`/services/${course.id}`}>
                            <div className="feature-card w-72 px-5 h-auto pt-6 pb-4 flex-center text-center cursor-pointer">
                                <Image
                                    src={`${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/pdfs/${course?.thumbnail_url}` || "/images/courses/affiliate-marketing.jpg"}
                                    alt={course.title}
                                    width={245}
                                    height={150}
