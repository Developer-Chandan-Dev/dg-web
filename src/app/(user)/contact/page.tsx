...
const ContactPage = () => {
  return (
    <section className={"w-full h-auto xl:w-[1200px] mx-auto"}>
      <div
        className={"flex h-82 items-center justify-center flex-col text-center"}
      >
        <div className={" w-[90%] sm:w-[60%] lg:w-[50%]"}>
          ...
          <p className={"py-2"}>
            ...
            here and get pdf for reading. Have questions or need support? Reach
            out to us — we’re here to help you get started on your digital
            journey.
          </p>
        </div>
      </div>
      ...
      <div
        className={
          "flex items-center justify-center w-full gap-5 flex-wrap px-5"
        }
      >
        <div className={"feature-card w-64 flex-center flex-col"}>
          <div
            className={
              "flex-center bg-cyan-500 text-white size-10 rounded-full shadow-xl shadow-cyan-700 transition-all hover:shadow-[0px_0px_25px_cyan] hover:-translate-y-1"
            }
          >
